...
export const itemLookup: Record<string, ItemInfo> = {
  ...
  "Claws of Attack +3": { imageFile: "ClawsOfAttack", source: "Drop" },
  "Claws of Attack +6": { imageFile: "ClawsOfAttack", source: "Drop" },
  ...
  "Orb of Lightning": { imageFile: "OrbOfLightning", source: "Shop" },
