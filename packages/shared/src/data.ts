...
const baseMaps: Omit<MapGuide, "shops">[] = [
  ...
  },
  {
    ...
    availableItems: ["Boots of Speed", "Claws of Attack +6", "Periapt of Vitality", "Ancient Janggo of Endurance", "Staff of Sanctuary", "Scroll of Town Portal", "Healing Salve", "Clarity Potion", "Dust of Appearance", "Orb of Lightning", "Orb of Frost", "Mask of Death", "Helm of Valor", "Robe of the Magi", "Khadgar's Gem of Health"],
  ...
  },
  {
    ...
    availableItems: ["Boots of Speed", "Claws of Attack +6", "Periapt of Vitality", "Ancient Janggo of Endurance", "Staff of Sanctuary", "Scroll of Town Portal", "Healing Salve", "Clarity Potion", "Dust of Appearance", "Orb of Lightning", "Orb of Frost", "Mask of Death", "Khadgar's Gem of Health"],
  ...
  },
  {
    ...
    availableItems: ["Boots of Speed", "Claws of Attack +6", "Periapt of Vitality", "Ancient Janggo of Endurance", "Staff of Sanctuary", "Scroll of Town Portal", "Healing Salve", "Clarity Potion", "Dust of Appearance", "Orb of Lightning", "Orb of Frost", "Orb of Corruption", "Mask of Death", "Helm of Valor", "Robe of the Magi", "Khadgar's Gem of Health"],
  ...
  },
  {
    ...
    availableItems: ["Boots of Speed", "Claws of Attack +6", "Periapt of Vitality", "Ancient Janggo of Endurance", "Staff of Sanctuary", "Scroll of Town Portal", "Healing Salve", "Clarity Potion", "Dust of Appearance", "Orb of Lightning", "Orb of Frost", "Mask of Death", "Helm of Valor", "Robe of the Magi"],
  ...
  },
  {
    ...
    availableItems: ["Boots of Speed", "Claws of Attack +6", "Periapt of Vitality", "Ancient Janggo of Endurance", "Staff of Sanctuary", "Scroll of Town Portal", "Healing Salve", "Clarity Potion", "Dust of Appearance", "Orb of Lightning", "Orb of Corruption", "Mask of Death", "Helm of Valor", "Robe of the Magi", "Khadgar's Gem of Health"],
...
export const buildings: Building[] = [
  ...
  { name: "Scout Tower",     race: "human", description: "Base defense tower costing only 30 gold. Upgrades into Guard, Cannon, or Arcane Tower.", imageFile: "ScoutTower",    gold:  30, lumber:  10, tip: "Place Scout Towers at expansion ramps and creep spawn points early. A single Arcane Tower upgrade hard-counters Blademaster and caster-heavy openers.", produces: ["Upgrades to Guard Tower", "Upgrades to Cannon Tower", "Upgrades to Arcane Tower"] },
  { name: "Guard Tower",     race: "human", description: "Ground-focused defense tower upgraded from Scout Tower. Solid mid-range damage against melee.", imageFile: "GuardTower",    gold: 110, lumber:  20, tip: "Guard Towers are your general-purpose defense. Cluster two or three at your natural expansion to deter raider and beastmaster dive patterns.", produces: ["Deals ranged damage to ground units"] },
  { name: "Arcane Tower",    race: "human", description: "Anti-magic defense tower upgraded from Scout Tower. Burns mana from spellcasters every attack.", imageFile: "ArcaneTower",   gold:  50, lumber:  50, tip: "One Arcane Tower at your base entrance punishes Blademaster harassment and drains Undead statue mana on dives. A cheap tech response to spellcaster-heavy races.", produces: ["Burns mana from spellcasters on each attack", "Deals ranged damage to ground and air units"] },
  { name: "Cannon Tower",    race: "human", description: "Siege-capable tower upgraded from Scout Tower. Deals splash damage and destroys buildings.", imageFile: "CannonTower",   gold:  90, lumber:  60, tip: "Cannon Towers are niche — use them to defend an expansion against mass ground units or to snipe a hasty enemy base. Rare on ladder but situationally strong.", produces: ["Deals splash siege damage to ground units and buildings"] },
  { name: "Workshop",        race: "human", description: "Trains Flying Machines, Mortar Teams, and Siege Engines. Requires Keep.", imageFile: "Workshop",       gold: 200, lumber:   0, tip: "Flying Machines provide cheap anti-air. Build Workshop early versus Night Elf if you expect Chimaera or Hippogriff tech to threaten your expansions.", produces: ["Trains Flying Machines", "Trains Mortar Teams", "Trains Siege Engines (requires Castle)"] },
  { name: "Gryphon Aviary",  race: "human", description: "Trains Gryphon Riders and Dragonhawk Riders. Requires Castle for production.", imageFile: "GryphonAviary",  gold: 150, lumber: 100, tip: "Gryphons are an expensive late-game investment. Only build the Aviary if you have map control and can afford to float resources without falling behind on ground army.", produces: ["Trains Gryphon Riders (requires Castle)", "Trains Dragonhawk Riders (requires Castle)"] },
  { name: "Arcane Sanctum",  race: "human", description: "Trains Priests, Sorceresses, and Spell Breakers. Primary source of Human spell support.", imageFile: "ArcaneSanctum",  gold: 150, lumber:   0, tip: "Build Arcane Sanctum immediately after Keep. Two Priests with Heal running sustain any engagement — skipping this building is the most common Human macro mistake.", produces: ["Trains Priests", "Trains Sorceresses", "Trains Spell Breakers (requires Castle)"] },
  { name: "Arcane Vault",    race: "human", description: "Sells permanent and consumable items for Human heroes including orbs and potions.", imageFile: "ArcaneVault",    gold: 150, lumber:   0, tip: "Always buy Scroll of Town Portal early. An instant recall saves heroes from bad engagements and is worth more than almost any other item investment in the game.", produces: ["Sells Orbs and permanent items", "Sells Potions and consumables", "Sells Scroll of Town Portal"] },
  ...
  { name: "Stronghold",      race: "orc", description: "Tier 2 upgrade of Great Hall. Unlocks Spirit Lodge, Tauren Totem, and advanced Orc units.", imageFile: "Stronghold",     gold: 265, lumber: 200, tip: "Prioritise Spirit Lodge after Stronghold. Shaman Purge removes Entangle and is one of the most important tech picks in Orc's Tier 2 toolkit.", produces: ["Unlocks Raiders", "Unlocks Troll Batriders", "Unlocks Spirit Lodge", "Upgrades to Fortress"] },
  { name: "Fortress",        race: "orc", description: "Tier 3 upgrade granting the full Orc army tech tree including Tauren and Spirit Walker.", imageFile: "Fortress",       gold: 340, lumber: 225, tip: "Fortress is only necessary for Tauren or Spirit Walker-based compositions. Most Orc games are decided well before Tier 3 — only commit if your economy is ahead.", produces: ["Unlocks Tauren", "Unlocks Spirit Walkers", "Unlocks Tauren Totem"] },
  { name: "Orc Burrow",      race: "orc", description: "Provides 10 food supply and acts as a burrowed defensive structure during attacks.", imageFile: "OrcBurrow",      gold:  80, lumber:  20, tip: "Burrow your Burrows when your base is under pressure — burrowed Burrows are tough to kill and buy time. Build extras at your expansion before your opponent scouts it.", produces: ["Provides +10 food supply", "Can burrow for additional defense"] },
  { name: "War Mill",        race: "orc", description: "Researches weapon and armor upgrades for Orc units. Required for Tier 2 structures.", imageFile: "WarMill",        gold: 120, lumber:  50, tip: "Research Steel Melee Weapons first. Grunt and Raider damage upgrades directly improve your hero focus fire and the melee trades that define Orc midgame.", produces: ["Researches Steel Melee Weapons", "Researches Steel Ranged Weapons", "Researches Reinforced Defenses (armor)", "Required for Stronghold upgrade"] },
  { name: "Barracks",        race: "orc", description: "Trains Grunts, Headhunters, Raiders, and Troll Batriders. Core Orc production building.", imageFile: "Beastiary",      gold: 180, lumber:   0, tip: "Queue Raiders as soon as they unlock — Ensnare is one of the most impactful abilities in the game and lets you catch fleeing heroes after every engagement.", produces: ["Trains Grunts", "Trains Headhunters", "Trains Raiders (requires Stronghold)", "Trains Troll Batriders (requires Stronghold)"] },
  { name: "Spirit Lodge",    race: "orc", description: "Trains Shamans, Witch Doctors, and Spirit Walkers. Requires Stronghold.", imageFile: "SpiritLodge",    gold: 150, lumber:   0, tip: "One Shaman with Purge immediately answers Entangle, Frost Nova, and other roots. Build Spirit Lodge before your first big fight at Tier 2.", produces: ["Trains Shamans", "Trains Witch Doctors", "Trains Spirit Walkers (requires Fortress)"] },
  { name: "Watch Tower",     race: "orc", description: "Defensive tower that deals ranged damage. Can be upgraded for increased effectiveness.", imageFile: "WatchTower",     gold:  30, lumber:  10, tip: "Orc players often skip towers in favour of aggressive play — but a Watch Tower at your expansion ramp deters scouting Wisps and early harassment without much investment.", produces: ["Deals ranged damage to ground and air units"] },
  { name: "Goblin Laboratory", race: "orc", description: "Trains Goblin Sappers and Goblin Zeppelins for scouting and explosive harassment.", imageFile: "GoblinLaboratory", gold: 130, lumber:   0, tip: "A single Zeppelin provides fast map vision and can body-block Wisps from entangling your expansion mine. Worth building early versus Night Elf.", produces: ["Trains Goblin Sappers", "Trains Goblin Zeppelins"] },
  { name: "Tauren Totem",    race: "orc", description: "Trains Tauren warriors and researches Pulverize and Reincarnation upgrades.", imageFile: "TaurenTotem",    gold: 150, lumber:   0, tip: "Reincarnation on a front-line Tauren Chieftain hero is a powerful fight-extender. Pulverize upgrades pair with Blademaster focus fire to delete units instantly.", produces: ["Trains Tauren (requires Fortress)", "Researches Pulverize", "Researches Reincarnation (hero upgrade)"] },
  { name: "Voodoo Lounge",   race: "orc", description: "Sells items and consumables for Orc heroes. Stocks healing salves and orbs.", imageFile: "VoodooLounge",   gold: 150, lumber:   0, tip: "Healing Salves are Orc's primary sustain tool in the early game. Keep 1–2 on your Blademaster at all times to extend aggressive creep routes.", produces: ["Sells Healing Salves and consumables", "Sells Orbs and permanent items", "Sells Scroll of Town Portal"] },
  ...
  { name: "Tomb of Relics",  race: "undead", description: "Sells permanent and consumable items for Undead heroes including Orb of Corruption.", imageFile: "TombOfRelics",   gold: 130, lumber:   0, tip: "Orb of Corruption on Death Knight gives your primary hero a reliable armor debuff. It makes every subsequent attack on a target unit deal more damage for the rest of the fight.", produces: ["Sells Orb of Corruption", "Sells Sobi Mask and permanent items", "Sells Potions and consumables", "Sells Scroll of Town Portal"] },
  { name: "Sacrificial Pit", race: "undead", description: "Trains Banshees and allows conversion of Banshees into Destroyers via Metamorphosis.", imageFile: "SacrificialPit", gold: 135, lumber:   0, tip: "Destroyers with Orb of Annihilation dispel buffs on every attack — they hard-counter Priest-based Human and Druid-heavy Night Elf compositions at minimal cost.", produces: ["Trains Banshees", "Converts Banshees into Destroyers (Metamorphosis)"] },
  // Night Elf
  { name: "Tree of Life",    race: "night-elf", description: "Primary Night Elf base that trains Wisps and entangles gold mines. Upgrades to Tree of Ages.", imageFile: "TreeOfLife",     gold: 385, lumber: 185, tip: "Use your Tree of Life's uproot ability to reposition during attacks. Night Elf bases are mobile — a retreating Tree denies siege damage and buys production time.", produces: ["Trains Wisps", "Entangles gold mines", "Upgrades to Tree of Ages"] },
  { name: "Tree of Ages",    race: "night-elf", description: "Tier 2 upgrade of Tree of Life. Unlocks Ancient of Wind, Ancient of Lore, and advanced units.", imageFile: "TreeOfAges",     gold: 265, lumber: 200, tip: "Start Tree of Ages once you have your first Ancient of War up. Night Elf timing attacks with Huntresses and a second hero at Tier 2 are among the strongest in the game.", produces: ["Unlocks Huntresses", "Unlocks Glaive Throwers", "Unlocks Ancient of Wind", "Unlocks Ancient of Lore", "Upgrades to Tree of Eternity"] },
  { name: "Tree of Eternity", race: "night-elf", description: "Tier 3 upgrade giving the full Night Elf tech tree including Chimaera Roost.", imageFile: "TreeOfEternity",  gold: 340, lumber: 225, tip: "Chimaera timing attacks from Tree of Eternity can end games before opponents reach equivalent Tier 3 tech. Only commit once your lumber income can sustain the lumber-heavy Chimaera cost.", produces: ["Unlocks Chimaera Roost", "Unlocks Chimaeras"] },
  ...
  { name: "Ancient of War",  race: "night-elf", description: "Trains Archers, Huntresses, and Glaive Throwers. Core Night Elf ground production building.", imageFile: "AncientOfWar",   gold: 180, lumber:   0, tip: "Build a second Ancient of War when transitioning to Huntress-heavy compositions. Huntresses are food-expensive and you need fast replenishment after any engagement.", produces: ["Trains Archers", "Trains Huntresses (requires Tree of Ages)", "Trains Glaive Throwers (requires Tree of Ages)"] },
  { name: "Ancient of Wind", race: "night-elf", description: "Trains Hippogryphs, Faerie Dragons, and Chimaeras. Primary Night Elf air production building.", imageFile: "AncientOfWind",  gold: 160, lumber:  50, tip: "Faerie Dragons from Ancient of Wind hard-counter mass spellcaster compositions. Build one early in matchups where the opponent relies on Priests or Witch Doctors.", produces: ["Trains Hippogryphs", "Trains Faerie Dragons", "Trains Chimaeras (requires Tree of Eternity)"] },
  { name: "Ancient of Lore", race: "night-elf", description: "Trains Druids of the Claw and Druids of the Talon. Key source of Night Elf spellcasters.", imageFile: "AncientOfLore",  gold: 160, lumber:  60, tip: "Druid of the Talon's Faerie Fire provides permanent vision and armor reduction. A few Druids with Faerie Fire dramatically increase the damage your entire army deals.", produces: ["Trains Druids of the Claw", "Trains Druids of the Talon", "Researches Druid of the Claw upgrades", "Researches Druid of the Talon upgrades"] },
  { name: "Ancient of Wonders", race: "night-elf", description: "Sells items and consumables for Night Elf heroes including Staff of Preservation.", imageFile: "AncientOfWonders", gold: 130, lumber:   0, tip: "Staff of Preservation is Night Elf's best item — teleporting a low-health hero or a key unit out of a fight can completely reverse its outcome.", produces: ["Sells Staff of Preservation", "Sells Orbs and permanent items", "Sells Potions and consumables", "Sells Scroll of Town Portal"] },
  { name: "Ancient Protector", race: "night-elf", description: "Defensive tower that can uproot and move across the map. Flexible base defense option.", imageFile: "AncientProtector", gold:  75, lumber:  75, tip: "Uprooting Ancient Protectors and walking them toward a push is a legitimate aggressive option on small maps. Opponents rarely expect mobile towers joining their army's flank.", produces: ["Deals ranged damage to ground units", "Can uproot and reposition across the map"] },
  { name: "Hunter's Hall",   race: "night-elf", description: "Researches weapon, armor, and Night Elf-specific upgrades like Improved Bows and Strength of the Moon.", imageFile: "HuntersHall",    gold: 125, lumber:  25, tip: "Strength of the Moon attack upgrade is unique to Night Elf and applies to all ranged units. Research it early to pull ahead of the opponent's comparable upgrade timings.", produces: ["Researches Strength of the Moon (ranged damage)", "Researches Ultravision (night vision)", "Researches Moon Armor upgrades"] },
  { name: "Chimaera Roost",  race: "night-elf", description: "Trains Chimaeras and researches Chimaera upgrades. Requires Tree of Eternity.", imageFile: "ChimaeraRoost",  gold: 160, lumber:  60, tip: "Chimaera Acid upgrades let your Chimaeras splash acid that permanently reduces building armor. This combined with the base splash damage can demolish an undefended expansion instantly.", produces: ["Trains Chimaeras (requires Tree of Eternity)", "Researches Chimaera Acid (splash damage upgrade)"] },
